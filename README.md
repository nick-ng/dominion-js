...
- src/lib/components/card.svelte:180: @todo(nick-ng): figure out a better way to recognise dragging
- src/lib/components/card.svelte:204: @todo(nick-ng): add tooltip to cards for extra rules
